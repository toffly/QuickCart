    ...
    <>
      ...
      <div onClick={resetForm} className="fixed inset-0 z-50 flex-center p-4">
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 text-sm rounded-xl border border-app-border focus-within:border-app-green outline-none"
                value={form.label}
          ...
          <button
            type="submit"
            className="mt-6 w-full py-3 bg-app-green text-white rounded-xl hover:bg-app-green-light transition-colors"
          >
